...
Route::get('postAll', [PostController::class, 'user_index'])->name('post.user_index');
Route::get('postAll/{post:slug}', [PostController::class, 'show_user_post'])->name('post.show_user_post');
