                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-4">
                                                @if ($post->hasMedia())
                                                    <img class="img-fluid" src="{{ $post->getFirstMediaUrl() }}"
                                                        alt="">
                                                @else
                                                    <img class="img-fluid" src="/storage/defaut_img/not found.png"
                                                        alt="">
                                                @endif
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('admin.post.edit', ['post' => $post->id]) }}"
                                                class="btn btn-warning  me-2"><i class="fa-solid fa-pen"></i></a>
